...
import 'package:my_places_app/screens/map.dart';
...
class _LocationInputState extends State<LocationInput> {
  ...
  Future<void> _savePlace(double latitude, double longitude) async {
    final url = Uri.parse(
        'https://maps.googleapis.com/maps/api/geocode/json?latlng=$latitude,$longitude&key=AIzaSyAtS2wwz3KKg6vvUay3GAR2GJuISQKsFQI');
